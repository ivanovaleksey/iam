...
mod with_enabled_record {
    ...
    #[test]
    fn admin_cannot_enable_account() {
    ...
    #[test]
    fn client_cannot_enable_account() {
        let shared::Server { mut srv, pool } = shared::build_server();
    ...
    #[test]
    fn anonymous_cannot_enable_account() {
        let shared::Server { mut srv, pool } = shared::build_server();
